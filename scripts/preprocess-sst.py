...
def split(sst_dir, train_dir, dev_dir, test_dir):
    sents = load_sents(sst_dir) # 11855
    splits = load_splits(sst_dir) # 11855
    parents = load_parents(sst_dir) # 11855
...
if __name__ == '__main__':
    ...
    make_dirs([train_dir, dev_dir, test_dir]) # make train test decv folder
